...
<body>
	...
	<div class="estates_accommodations_hotel__white">
		...
		<!-- RESPONSIVE TITLE -->
		<div class="container">
			<h2 class="estates_accommodations_hotel__h2_responsive">Legacy Suite</h2>
		</div>
		...
		<div class="container">
			...
			<div class="estates_accommodations_hotel__white__text">
				...
				<h2 class="estates_accommodations_hotel__white__text__h2">Legacy Suite</h2>
	...
	<div class="estates_accommodations_hotel__green">
		...
		<!-- RESPONSIVE TITLE -->
		<div class="container">
			<h2 class="estates_accommodations_hotel__h2_responsive estates_accommodations_hotel__h2_responsive--white">Legacy Master Suite</h2>
		</div>
		...
		<div class="container">
			...
			<div class="estates_accommodations_hotel__green__text">
				...
				<h2 class="estates_accommodations_hotel__green__text__h2">Legacy Master Suite</h2>
	...
	<div class="estates_accommodations_hotel__white">
		...
		<!-- RESPONSIVE TITLE -->
		<div class="container">
			<h2 class="estates_accommodations_hotel__h2_responsive">Grand Legacy Junior Suite</h2>
		</div>
		...
		<div class="container">
			...
			<div class="estates_accommodations_hotel__white__text">
				...
				<h2 class="estates_accommodations_hotel__white__text__h2">Grand Legacy Junior Suite</h2>
	...
	<div class="estates_accommodations_hotel__green">
		...
		<!-- RESPONSIVE TITLE -->
		<div class="container">
			<h2 class="estates_accommodations_hotel__h2_responsive estates_accommodations_hotel__h2_responsive--white">Grand Legacy Suite</h2>
		</div>
		...
		<div class="container">
			...
			<div class="estates_accommodations_hotel__green__text">
				...
				<h2 class="estates_accommodations_hotel__green__text__h2">Grand Legacy Suite</h2>
	...
	<!-- Grand Legacy Master Suite -->
	<div class="estates_accommodations_hotel__white">

		<!-- RESPONSIVE TITLE -->
		<div class="container">
			<h2 class="estates_accommodations_hotel__h2_responsive">Grand Legacy Master Suite</h2>
		</div>
		...
		<div class="container">
			...
			<div class="estates_accommodations_hotel__white__text">
				...
				<h2 class="estates_accommodations_hotel__white__text__h2">Grand Legacy Master Suite</h2>
			...
			<button class="estates_accommodations_hotel__white__img" onclick="openEstatesThreeBedroomModal()">
				<img src="../img/accommodations/bedrooms/prime-line-grand-master-suite.webp" alt="">
	...
	<!--Grand Legacy Master Suite MODAL -->
	<div class="estates_accommodations_hotel__modal" id="estatesThreeBedroomModal">
		...
		<div class="container">
			<h1 class="estates_accommodations_hotel__modal__title">Grand Legacy Master Suite</h1>
		</div>

		<img src="../img/accommodations/floorplans/prime-line-grand-master-suite-floorplan.webp" alt="">
