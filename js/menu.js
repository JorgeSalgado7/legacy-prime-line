...
const menuLinks = [
  {
    name: "HERITAGE",
    link: "/royal-legacy-park-prime-line/heritage",
    active: currentPage.includes("heritage") ? true : false,
  },
  {
    name: "THE DIFFERENCE",
    link: "/royal-legacy-park-prime-line/the-difference",
    active: currentPage.includes("difference") ? true : false,
  },
  {
    name: "VALUES",
    link: "/royal-legacy-park-prime-line/values",
    active: currentPage.includes("values") ? true : false,
  },
  {
    name: "Legacy Park Resort",
    link: "/royal-legacy-park-prime-line/royal-legacy-park",
    active: currentPage.includes("/royal-legacy-park-prime-line/royal-legacy-park") ? true : false,
  },
  {
    name: "ACCOMMODATIONS",
    link: "/royal-legacy-park-prime-line/accommodations",
    active: currentPage.includes("accommodations") ? true : false,
  },
  {
    name: "AMENITIES",
    link: "/royal-legacy-park-prime-line/amenities",
    active: currentPage.includes("amenities") ? true : false,
  },
  // {
  //   name: "GALLERY",
  //   link: "/royal-legacy-park-prime-line/gallery",
  //   active: currentPage.includes("gallery") ? true : false,
  // },
  // {
  // 	name: 'NEWS',
  // 	link: '/royal-legacy-park-prime-line/news.html',
